...
def create_circle(draw, matrix_size):
    radius = random.randint(1, matrix_size // 2 - 1)
...
def create_ellipse(draw, matrix_size):
    x_radius = random.randint(1, matrix_size // 2 - 1)
    y_radius = random.randint(1, matrix_size // 2 - 1)
    x = random.randint(x_radius, matrix_size - x_radius - 1)
    y = random.randint(y_radius, matrix_size - y_radius - 1)
    ...
    for i, group in enumerate(groups):
        for j, img in enumerate(group):
            if j == 0:
                ...
                filename = f"{file_prefix}_group_{i}_shape_of_Eclipse.png"
            elif j == 2:
...
Photo_to_Binary_list(
    r"C:\Users\barva\PycharmProjects\Giraffe\Neuron Network\Set_of_data\Set of groups_group_0_shape_of_Circle.png")
# Photo_to_Binary_list(
#    r"C:\Users\barva\PycharmProjects\Giraffe\Neuron Network\Set_of_data\Set of groups_group_0_shape_of_Eclipse.png")
# Photo_to_Binary_list(
#    r"C:\Users\barva\PycharmProjects\Giraffe\Neuron Network\Set_of_data\Set of groups_group_0_shape_of_triangle.png")
